...
# python cost_aware_ft.py --load_path pretrained_unweighted --model_path all_finetuned_unweighted_hist10_output25_no_transitiions_costs_1e-04 --n_epochs 150 --input_n 10 --output_n 25 --lr_ft 1e-04 --cost_weight 100
